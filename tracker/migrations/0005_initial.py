...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Cordinate'
        db.create_table(u'tracker_cordinate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'tracker', ['Cordinate'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Cordinate'
        db.delete_table(u'tracker_cordinate')
